        ...
        function fieldChanged(scriptContext) {
            ...
            if (fieldid === 'custrecord_jj_transaction_currency') {
                try {
                    ...
                    log.error("Amount: " + amount);
                    const apiUrl = `https://api.freecurrencyapi.com/v1/latest?apikey=fca_live_jPzUlNbwXZ64p5A6Qiwo99xjn2S3xNlXavdSI1Ue&currencies=${currency}&base_currency=INR`;
                    fetch(apiUrl)
                        .then(response => {
                            if (!response.ok) {
                        ...
                        .then(data => {
                            ...
                            exchangeRate = parseFloat(data.data[currency]);
                            console.log(exchangeRate);
                            const transamount = exchangeRate * amount;
